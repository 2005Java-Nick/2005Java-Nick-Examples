...
function setPlayerCards() {
    var card1Value = generateCardValue();
    
    var card2Value = generateCardValue();
    ...
    card1.innerHTML = card1Value;

    var card2 = document.getElementById("playerCard2");
    card2.innerHTML = card2Value;

    var card1SuiteUrl = suitUrls[(Math.floor(Math.random() * 4))];

    console.log(card1SuiteUrl);
    
    var card1Suite = document.createElement("img");
    card1Suite.setAttribute("src", card1SuiteUrl);
    
    card1.appendChild(card1Suite);

    
    var card2SuiteUrl = suitUrls[(Math.floor(Math.random() * 4))];
    
    var card2Suite = document.createElement("img");
    card2Suite.setAttribute("src", card2SuiteUrl);
    
    card2.appendChild(card2Suite);
